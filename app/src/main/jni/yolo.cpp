...
int Yolo::draw(cv::Mat& rgb, const std::vector<Object>& objects)
{
    static const char* class_names[] = {
            "Dermacentor-Reticulatus-F", "Dermacentor-Reticulatus-Fed", "Dermacentor-Reticulatus-M",
            "ixodes_ricinus-f", "ixodes_ricinus-fed", "ixodes_ricinus-m",
            "rhipicephalus_sanguieus-f", "rhipicephalus_sanguieus-fed", "rhipicephalus_sanguineus-m"
